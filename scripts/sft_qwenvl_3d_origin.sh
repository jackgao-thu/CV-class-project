...
MODEL_PATH="/home/gaoj/share4/vlm-finetune/trl/ctrate-qwenvl-32-364-rg-origin-3-epoch"
nproc_per_node=2
...
accelerate launch \
    ...
    /home/gaoj/share4/vlm-finetune/trl/src/sft_qwenvl_3d.py \
    ...
    --gradient_accumulation_steps $(expr 16 / $nproc_per_node / 2) \
    --learning_rate 2e-5 \
